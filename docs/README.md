...
This directory contains the documentation for `@nodelibraries/circuit-breaker`, built with [VitePress](https://vitepress.dev/).
...
`https://nodelibraries.github.io/circuit-breaker/`
...
```typescript
base: '/circuit-breaker/', // Change to match your repo name
```
